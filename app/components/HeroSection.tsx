			...
			<div className="container mx-auto px-4 z-10">
				<div className="text-center mb-8">
					...
					<p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed px-4">
						Designing reliable backend architectures using
						<span className="text-blue-400"> Node.js</span>,<span className="text-purple-400"> PHP </span>, and
				...
				<div className="max-w-3xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-12 px-2">
					{[
						{
							label: 'Built REST/GraphQL services handling millions of requests daily',
							value: 'API',
							icon: (
						...
						{
							label: 'Implemented caching & load balancing for large-scale traffic',
							value: 'Backend',
							icon: (
						...
						{
							label: 'Designed schemas handling terabytes of structured & unstructured data',
							value: 'Database',
							icon: (
						...
						{
							label: 'Automated CI/CD pipelines with zero-downtime releases across cloud',
							value: 'Cloud',
							icon: (
							...
							<div className="relative p-8">
								...
								<div className="flex justify-center">
									<div className="inline-flex items-center gap-1.5 px-4 py-1 rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 group-hover:border-blue-400/30 transition-colors">
										...
										<span className="text-blue-400 text-sm font-medium">Featured Skillset</span>
									</div>
								</div>
								...
								<div className="text-center mt-6">
									...
									<p className="text-gray-400 mb-6 group-hover:text-gray-300 transition-colors">Delivering scalable, high-performance systems</p>

									{/* Features Pills */}
									<div className="flex flex-wrap justify-center gap-2">
										{['Database Scaling', 'Load Balancing', 'API Design'].map((feature, index) => (
											<span
												key={index}
