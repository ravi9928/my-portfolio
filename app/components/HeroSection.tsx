      ...
      <div className="container mx-auto px-4 z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed px-4">
            ...
            <span className="text-purple-400"> PHP </span>, and
            <span className="text-blue-400"> Angular</span>
          </p>
        </div>

        {/* App Store Stats */}
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-12 px-2">
          {[
            {
              label:
                "Built REST/GraphQL services handling millions of requests daily",
              value: "API",
              icon: (
                <svg
            ...
            {
              label:
                "Implemented caching & load balancing for large-scale traffic",
              value: "Backend",
              icon: (
                <svg
            ...
            {
              label:
                "Designed schemas to manage terabytes of structured and raw data",
              value: "Database",
              icon: (
            ...
            {
              label: "Automated CI/CD pipelines with seamless deployments",
              value: "Cloud",
              icon: (
                <svg
              ...
              <div className="relative p-8">
                ...
                <div className="text-center mt-6">
                  ...
                  <p className="text-gray-400 mb-6 group-hover:text-gray-300 transition-colors">
                    Delivering scalable, high-performance systems
                  </p>

                  {/* Features Pills */}
                  <div className="flex flex-wrap justify-center gap-2">
                    {["Database Scaling", "Load Balancing", "API Design"].map(
                      (feature, index) => (
                        <span
                          key={index}
