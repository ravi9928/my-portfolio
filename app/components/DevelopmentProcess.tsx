...
const processes: Process[] = [
	{
		...
		steps: ['Requirements gathering and market research', 'System architecture & database schema design', 'Interactive prototype development'],
	},
	{
		title: 'Development',
		colorClasses: {
	...
	},
	{
		...
		steps: ['App store optimization and submission', 'Analytics integration and monitoring', 'Performance optimization & continuous enhancements'],
	},
];

const DevelopmentProcess = () => {
	return (
		<section className="py-5 md:py-5 relative">
			<div className="container mx-auto px-4">
				<h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-center">Development Methodology</h2>
				<p className="text-sm sm:text-base text-gray-400 text-center mb-8 sm:mb-12 max-w-2xl mx-auto px-4">
					Engineering seamless user experiences with strong backend foundations
				</p>
