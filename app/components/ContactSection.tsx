      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
            Let&apos;s Build Scalable & Reliable Applications
          </h2>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Looking for a developer who can design robust APIs, manage
            databases, and deploy secure, high-performance systems? I focus on
            building scalable, reliable solutions that deliver real business
            impact.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="https://mail.google.com/mail/?view=cm&fs=1&to=ravirajsinghrathore167@gmail.com"
          ...
          <div className="flex justify-center gap-6">
            <a
              href="https://github.com/ravi9928"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/raviraj-singh-0aa3a916a/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-full"
            >
            ...
            <a
              href="https://x.com/Raviraj91986672"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-full"
            >
